...
public class IntroState extends BasicGameState {
	...
	public static int P1, P1Dir = 0;
	
	public static int LogNum = 0;
	public static Image purps;
	...
	public void update(GameContainer container, StateBasedGame sbg, int delta) throws SlickException {
		...
		if (container.getInput().isKeyPressed(Input.KEY_S)) { Recieve.Server(); }
		if (container.getInput().isKeyPressed(Input.KEY_C)) { Client.Send(); }
