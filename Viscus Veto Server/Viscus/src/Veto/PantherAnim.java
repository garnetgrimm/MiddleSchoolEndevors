...
public class PantherAnim {
	...
	public static void render(GameContainer container, Graphics g) throws SlickException {
		...
		if(Recieve.Started) {
		if(IntroState.P1Dir == 1) P1LeftWalk.draw((-IntroState.P1 / 10 + IntroState.x / 10) + 40, 29, 4f, 10f);
		else if(IntroState.P1Dir == -1) P1RightWalk.draw((-IntroState.P1 / 10 + IntroState.x / 10) + 40, 29, 4f, 10f);
		else P1Standing.draw((-IntroState.P1 / 10 + IntroState.x / 10) + 40, 29, 4f, 10f);
		}
	}
